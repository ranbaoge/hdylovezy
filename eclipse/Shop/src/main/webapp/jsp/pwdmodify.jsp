...
<div class="right">
            ...
            <div class="providerAdd">
                <form id="userForm" name="userForm" method="post" action="${ctx}/user/updatepwd">
                    ...
                    <div>
                        ...
                        <input type="password" id="rnewpassword" value=""> 
						<font color="red" id="renewpwd"></font>
						<input type="hidden" value="${ctx}" id="ctx">
                    </div>
                    <div class="providerAddBtn">
                        <!--<a href="#">保存</a>-->
                        <input type="button" id="save" value="保存" class="input-button">
                    </div>
                </form>
            </div>
        </div>
