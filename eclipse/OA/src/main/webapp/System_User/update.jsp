        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr><td>用户编号</td>
                        <td><input type="text" name="id" class="InputStyle" 
					...
					<tr><td>性别</td>
                        <td><input type="RADIO" name="gender" value="男" id="male" checked="checked"/><label for="male">男</label>
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
						<td width="100">岗位</td>
                        <td><select name="roleId" multiple="true" size="10" class="SelectStyle">
