        ...
        <table id="tab">
            ...
            <c:forEach items="${set}" var="s">
             <tr>
               ...
               <td>${name}</td>
               <td>
                  <a href="repassword.jsp?username=${s.username }" class="update">修改密码</a>&nbsp;
                  <a href="delete.do?id=${s.id}&page=1" class="delete">删除</a>
               </td>
            </tr>
            </c:forEach>
         ...
         <tr id="pageTr" style="color: grey;">
          <td colspan="7" align="center">
            <a href="queryByClass.do?page=1&id=${id }">首页</a>&nbsp;&nbsp;
            <a href="queryByClass.do?page=${page-1}&id=${id}" id="upPage">上一页</a>&nbsp;&nbsp;
            <a href="queryByClass.do?page=${page+1}&id=${id}" id="downPage">下一页</a>&nbsp;&nbsp;
            ...
            <a href="queryByClass.do?page=${endPage}&id=${id}">尾页</a>
          </td>
         </tr>
        </table>
